...
INSERT INTO `sco_routes` VALUES ('9', '8', '', '新增路由', 'admin.system.route.add', 'admin/system/route/add/{pid?}', 'Admin\\System\\RouteController@getAdd', 'get', 'web|auth:admin', '0', '1', '1', '新增路由', '2016-08-05 16:50:19', '2016-09-02 15:31:18');
INSERT INTO `sco_routes` VALUES ('10', '8', '', '保存新增路由', 'admin.system.route.postAdd', 'admin/system/route/postAdd', 'Admin\\System\\RouteController@postAdd', 'post', 'web|auth:admin', '0', '1', '1', '保存新增路由', '2016-08-05 16:50:19', '2016-08-05 16:50:19');
...
INSERT INTO `sco_routes` VALUES ('12', '8', '', '保存编辑路由', 'admin.system.route.postEdit', 'admin/system/route/{id}/edit', 'Admin\\System\\RouteController@postEdit', 'post', 'web|auth:admin', '0', '1', '1', '编辑路由保存', '2016-08-05 16:50:19', '2016-08-05 16:50:19');
...
INSERT INTO `sco_routes` VALUES ('20', '16', '', '保存添加用户', 'admin.users.user.postAdd', 'admin/users/user/postAdd', 'Admin\\Users\\UserController@postAdd', 'post', 'web|auth:admin', '0', '1', '0', '', '2016-08-11 16:39:43', '2016-08-11 16:39:43');
INSERT INTO `sco_routes` VALUES ('21', '16', '', '保存编辑用户', 'admin.users.user.postEdit', 'admin/users/user/{uid}/edit', 'Admin\\Users\\UserController@postEdit', 'post', 'web|auth:admin', '0', '1', '0', '', '2016-08-11 16:39:43', '2016-08-11 16:39:43');
...
INSERT INTO `sco_routes` VALUES ('25', '17', '', '保存新增角色', 'admin.users.role.postAdd', 'admin/users/role/postAdd', 'Admin\\Users\\RoleController@postAdd', 'post', 'web|auth:admin', '0', '1', '0', '', '2016-08-19 17:20:39', '2016-08-19 17:20:39');
...
INSERT INTO `sco_routes` VALUES ('27', '17', '', '保存编辑角色', 'admin.users.role.postEdit', 'admin/users/role/{id}/edit', 'Admin\\Users\\RoleController@postEdit', 'post', 'web|auth:admin', '0', '1', '0', '', '2016-08-19 17:20:39', '2016-08-19 17:20:39');
...
INSERT INTO `sco_routes` VALUES ('30', '17', '', '保存角色授权', 'admin.users.role.postAuthorize', 'admin/users/role/{id}/authorize', 'Admin\\Users\\RoleController@postAuthorize', 'post', 'web|auth:admin', '0', '1', '0', '', '2016-08-23 11:18:46', '2016-08-23 11:18:49');
INSERT INTO `sco_routes` VALUES ('31', '8', '', '刷新路由文件', 'admin.system.route.refresh', 'admin/system/route/refresh', 'Admin\\System\\RouteController@getRefresh', 'get', 'web|auth:admin', '0', '1', '0', '', '2016-09-05 16:51:43', '2016-09-05 16:51:43');
